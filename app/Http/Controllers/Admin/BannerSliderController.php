...
class BannerSliderController extends Controller
{
    ...
    public function show(string $id)
    {
        ...
        return view('admin.banner-slider.show', compact('bannerSlider'));
    }
    ...
    {
        $imagePath = $this->uploadImage($request, 'image', '', '/uploads/banner-slider');
        ...
        $bannerSlider->position = $request->position;
    ...
    {
        $imagePath = $this->uploadImage($request, 'image', $request->old_image,'/uploads/banner-slider');
