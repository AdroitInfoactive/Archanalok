    ...
    public function dataTable(QueryBuilder $query): EloquentDataTable
    {
        return (new EloquentDataTable($query))
            ->addColumn('action', function($query){
                $view = "<a href='".route('admin.banner-slider.show', $query->id)."' class='btn btn-info ml-2'><i class='fas fa-eye'></i></a>";
                $edit = "<a href='".route('admin.banner-slider.edit', $query->id)."' class='btn btn-primary ml-2'><i class='fas fa-edit'></i></a>";
