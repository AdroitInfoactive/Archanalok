        ...
        <div class="row justify-content-center"> <!-- Centering the row -->
            <div class="col-md-6 col-xl-3 mb-4"> <!-- Profile Box -->
                <div class="account-box">
                    ...
                    <h4>Profile</h4>
                    <a href="personal-info.html" class="btn">Edit Profile</a>
                </div>
            </div>
...
<style>
  ...
  .btn {
      background-color: #f36e2d; /* Button background color */
  ...
  .btn:hover {
      background-color: #E2EEFF; /* Darker color on hover */
      font-weight: bold;
  }
 ...
 .wrapper {
          ...
          .container-2 {
              ...
              padding: 20px;
              width: 500px; /* Set width for the profile container */
              /* border-radius: 10px; */
              text-align: center;
          ...
          .btn-edit {
              ...
              padding: 10px 15px;
              color: white;
              background-color: #f36e2d; /* Button color */
              border: none;
              border-radius: 5px;
              cursor: pointer;
          ...
          .btn-edit:hover {
              background-color: #E2EEFF; /* Darker shade on hover */
              font-weight: bold;
              color:#222F5A;
          }
  </style>    
