...
<body>
        ...
        <div class="row">
          <div class="col-12 col-sm-8 offset-sm-2 col-md-6 offset-md-3 col-lg-6 offset-lg-3 col-xl-4 offset-xl-4">
            {{-- <div class="login-brand">
              <img src="assets/img/avatar/avatar-5.png" alt="logo" width="100" class="shadow-light rounded-circle">
  ...
  <script>
      ...
      // toaster.showEasing = 'swing';
      // toaster.hideEasing = 'linear';
      // toaster.showMethod = 'fadeIn';
      // toaster.hideMethod = 'fadeOut';
