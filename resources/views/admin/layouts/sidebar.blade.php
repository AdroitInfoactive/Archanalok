    ...
    <aside id="sidebar-wrapper">
        ...
        <ul class="sidebar-menu">
            ...
            <li class="{{ setSidebarActive(['admin.banner-slider.*']) }}"><a class="nav-link"
                    href="{{ route('admin.banner-slider.index') }}"><i
                        class="fas fa-images"></i><span>Banner
                        Slider</span></a></li>
            <li
                ...
                <ul class="dropdown-menu">
                    <li
                        class="{{ setSidebarActive(['admin.main-category.*', 'admin.main-category-banner.*']) }}">
                        <a class="nav-link" href="{{ route('admin.main-category.index') }}">Product
                            Main
                            Categories</a></li>
                    <li class="{{ setSidebarActive(['admin.category.*']) }}"><a class="nav-link"
                            href="{{ route('admin.category.index') }}">Product Categories</a></li>
                    <li class="{{ setSidebarActive(['admin.sub-category.*']) }}"><a
                            class="nav-link" href="{{ route('admin.sub-category.index') }}">Product
                            Sub Categories</a></li>
                    <li class="{{ setSidebarActive(['admin.brand.*']) }}"><a class="nav-link"
                            href="{{ route('admin.brand.index') }}">Brands</a></li>
                    <li class="{{ setSidebarActive(['admin.variant-master.*']) }}"><a
                            class="nav-link"
                            href="{{ route('admin.variant-master.index') }}">Variants</a></li>
                    <li class="{{ setSidebarActive(['admin.variant-details.*']) }}"><a
                            class="nav-link"
                            href="{{ route('admin.variant-details.index') }}">Variants Details</a>
                    </li>
            ...
            <li class="{{ setSidebarActive(['admin.orders.index']) }}"><a class="nav-link"
                    href="{{ route('admin.orders.index') }}"><i class="fas fa-user"></i>
            ...
            <li
                ...
                <ul class="dropdown-menu">
                    ...
                    <li class="{{ setSidebarActive(['admin.privacy-policy.*']) }}"><a
                            class="nav-link" href="{{ route('admin.privacy-policy.index') }}">Privacy
                            Policy</a></li>
                    <li class="{{ setSidebarActive(['admin.shipping-policy.*']) }}"><a
                            class="nav-link"
                            href="{{ route('admin.shipping-policy.index') }}">Shipping Policy</a></li>
                    <li class="{{ setSidebarActive(['admin.return-policy.*']) }}"><a
                            class="nav-link" href="{{ route('admin.return-policy.index') }}">Return
                            Policy</a></li>

                    <li class="{{ setSidebarActive(['admin.terms-and-conditions.index*']) }}"><a
                            class="nav-link"
                            href="{{ route('admin.terms-and-conditions.index') }}">Terms And
                            Conditions</a></li>
                    <li class="{{ setSidebarActive(['admin.contact.index']) }}"><a
                            class="nav-link" href="{{ route('admin.contact.index') }}">Contact</a>
                    </li>

                </ul>
            </li>
            <li class="{{ setSidebarActive(['admin.user.status']) }}"><a class="nav-link"
                    href="{{ route('admin.user.status') }}"><i class="fas fa-user"></i>
            ...
            <li
                ...
                <ul class="dropdown-menu">
                    ...
                    <li class="{{ setSidebarActive(['admin.counter.index']) }}"><a
                            class="nav-link" href="{{ route('admin.counter.index') }}">Counter</a>
                    </li>
                    <li class="{{ setSidebarActive(['admin.home-info.index']) }}"><a
                            class="nav-link" href="{{ route('admin.home-info.index') }}">About Home
                            Page</a></li>
